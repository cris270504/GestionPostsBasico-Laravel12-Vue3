<template>
    <aside :class="['sidebar', { collapsed }]">
        ...
        <div class="sidebar-header" @click="toggleSidebar">
            ...
            <span v-if="!collapsed">Cristopher App</span>
        </div>
        ...
        <nav  class="nav-links">
            ...
            <!-- Posts Link -->
            <RouterLink to="/posts" class="nav-item" exact-active-class="active">
                <span class="icon">📝</span>
                <span v-if="!collapsed">Posts</span>
            </RouterLink>

            <!-- Authors Link -->
            <RouterLink to="/authors" class="nav-item" exact-active-class="active">
                <span class="icon">🙍‍♂️</span>
                <span v-if="!collapsed">Autores</span>
            </RouterLink>

            <!-- Dynamic Sections with submenus -->
            <template v-for="(section, index) in menuSections" :key="index">
                <div v-if="auth.can('ver usuarios')" class="nav-item parent-item" @click="toggleSubmenu(index)">
            ...
            <RouterLink to="/auth/logout" class="nav-item" exact-active-class="active">
                <span class="icon">🔒</span>
...
const menuSections = [
    {
        ...
        children: [
            { icon: '🙍‍♂️', label: 'Perfil', to: '/auth/profile' },
            { icon: '👥', label: 'Usuarios', to: '/auth/users' },
        ],
    },
]
